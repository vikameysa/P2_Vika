            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Data Surat Lamaran</h4>
                                <div class="form-validation">
                                    <form class="form-valide" action="#" method="post">
                                        <div class="form-group">
                                            <label>Kota & Tanggal</label>
                                            <input type="text" id="kotaTanggal" class="form-control input-default">
                                        </div>
                                        <div class="form-group">
                                            <label>Subject & Alamat</label>
                                            <input type="text" id="subjectAlamat" class="form-control input-default">
                                        </div>
                                        <div class="form-group">
                                            <label>Paragraph 1(Pembuka)
                                            </label>
                                            <textarea class="form-control" id="paragraf1" rows="5"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Paragraph 2(Isi)
                                            </label>
                                            <textarea class="form-control" id="paragraf2" rows="5"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Paragraph 3(Penutup)
                                            </label>
                                            <textarea class="form-control" id="paragraf3" rows="5"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Nama Penulis</label>
                                            <input type="text" id="namaPenulis" class="form-control input-default">
                                        </div>
